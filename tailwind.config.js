  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'card-hover': {
          '0%':   { transform: 'scale(1)', boxShadow: '0 4px 24px rgba(0,0,0,0.4)' },
          '100%': { transform: 'scale(1.05)', boxShadow: '0 20px 60px rgba(59,130,246,0.3), 0 0 30px rgba(59,130,246,0.2)' },
        },
        'glow-pulse': {
      ...
      boxShadow: {
        ...
        'cyan-glow':     '0 0 30px rgba(34,211,238,0.5), 0 0 60px rgba(34,211,238,0.2)',
        ...
        'premium-glass': '0 8px 32px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.1)',
        'neon-border':   '0 0 20px rgba(59,130,246,0.3), inset 0 0 20px rgba(59,130,246,0.1)',
      },
    },
  },
  plugins: [],
